module Humanize
  ...
  def humanize
    ...
    sets.each_with_index do |set, i|                          # TODO: should be able move this check out of the loop
      o << "#{three_digits_to_words(set)}#{LOTS[size_m1 - i]}#{' and' if i == size_m2 && sets[i.succ] < 100}"
    end
